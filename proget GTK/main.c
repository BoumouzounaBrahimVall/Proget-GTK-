...
///  window
    ...
    F=creer_Window(F);
///fixed
    fix=init_Fixed(d6,"fixed pricipale",F->window,walo());
    fix=creer_Fixed(fix);
///box
    box1=Init_box(NULL,"sousbox1",'v',0,
                  dimAdd(500,70),0,50,NULL,walo());
    box1=creer_Box(box1);

    box3=Init_box(NULL,"sousbox2",'H',0,
                  dimAdd(500,50),50,30,NULL,walo());
    box3=creer_Box(box3);

    box=Init_box(NULL,"box1",'v',0,
                 dimAdd(500,0),0,0,NULL,walo());
    box=creer_Box(box);
